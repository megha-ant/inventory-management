...
def get_quarterly_reports(
    ...
    # The global filter bar applies to every data view (see CLAUDE.md "Filter System"),
    # so reports honor the same four filters as the orders/dashboard endpoints.
    filtered_orders = apply_filters(orders, warehouse, category, status)
    filtered_orders = filter_by_month(filtered_orders, month)
...
def get_monthly_trends(
    ...
    # Same global filters as the other endpoints (see note on get_quarterly_reports).
    filtered_orders = apply_filters(orders, warehouse, category, status)
    filtered_orders = filter_by_month(filtered_orders, month)
